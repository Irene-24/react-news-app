      ...
      <div className={classes.Converter_Grid}>
        <div className={classes.Inputs}>
          ...
          <select onChange={props.pickCurrency} id="source">
            ...
            {options.map(opt => {
              return (
                <option key={opt.currencyName} value={opt.countryCode}>
                  {" "}
                  {opt.currencyName} {`( ${opt.currencySymbol} )`}
                </option>
              );
            })}
          </select>
          ...
          {props.source && props.target ? (
            <button
              onClick={props.convertCurrency}
              className={classes.Convert_Btn}
            >
              Convert
            </button>
          ) : (
        ...
        <div className={classes.Display}>
          ...
          <div className={classes.Convert_Icon}>
            <img
              ...
              src={convert}
              alt="two vertical arrows icon"
            />

            <img
              className={classes.Hori}
              src={convert_hori}
              alt="two horizontal arrows icon"
            />
          </div>
